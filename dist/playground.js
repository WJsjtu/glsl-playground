...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["GLSLPlayground"] = factory(require("React"), require("ReactDOM"));
	else
		root["GLSLPlayground"] = factory(root["React"], root["ReactDOM"]);
...
var _inDOM = __webpack_require__(0);
...
var _CodeMirrorEditor = __webpack_require__(10);
...
var Playground = function (_Component) {
    ...
    function Playground(props) {
        ...
        _this2.handleCodeChange = _this2.handleCodeChange.bind(_this2);
        _this2.onToggle = _this2.onToggle.bind(_this2);
        _this2.state = {
            isOpen: true,
            code: _this2.props.codeText
        };
        return _this2;
    }
    ...
    _createClass(Playground, [{
        ...
        key: 'executeCode',
        value: function executeCode(shader) {
            try {
        ...
        value: function componentDidMount() {
            var mountNode = (0, _reactDom.findDOMNode)(this.refs.mount);
            this.shaderInstance = new _FragmentShader2['default'](mountNode);
        ...
        value: function render() {
            ...
            return _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                    ...
                    _react2['default'].createElement(_CodeMirrorEditor2['default'], { onChange: this.handleCodeChange,
                ...
                _react2['default'].createElement(
                    'div',
                    { style: { position: 'absolute', top: 0, left: 0, margin: 0, padding: 0, zIndex: 997 } },
                    _react2['default'].createElement(
                        'canvas',
                        { width: window.innerWidth, height: window.innerHeight, ref: 'mount' },
...
Playground.propTypes = {
    ...
    showLineNumbers: _react.PropTypes.bool
};
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!./../node_modules/css-loader/index.js??ref--1-1!./fixStyle.css", function() {
			var newContent = require("!!./../node_modules/css-loader/index.js??ref--1-1!./fixStyle.css");
...
var CodeMirrorEditor = function (_Component) {
    ...
    _createClass(CodeMirrorEditor, [{
        key: 'componentDidMount',
        value: function componentDidMount() {
            this.editor = _codemirror2['default'].fromTextArea((0, _reactDom.findDOMNode)(this.refs.editor), {
        ...
        value: function render() {
            return React.createElement(
                ...
                React.createElement('textarea', { ref: 'editor', defaultValue: this.props.codeText })
            );
        }
    }]);
...
var _getWebGLContext = __webpack_require__(12);

var _getWebGLContext2 = _interopRequireDefault(_getWebGLContext);

var _loadShaders = __webpack_require__(13);

var _loadShaders2 = _interopRequireDefault(_loadShaders);
...
var FragmentShader = function () {
    function FragmentShader(element) {
        _classCallCheck(this, FragmentShader);

        this.element = element;
        this.context = (0, _getWebGLContext2['default'])(element);
        this.diposeCalls = [];
    }

    _createClass(FragmentShader, [{
        key: 'execute',
        value: function execute(fShaderSource) {
            var gl = this.context;
            if (!gl) return;

            this.dispose();

            var loadResult = (0, _loadShaders2['default'])(gl, FragmentShader.V_SHADER_SOURCE, fShaderSource);

            this.diposeCalls.push(loadResult.dispose);

            var program = loadResult.program;

            gl.clearColor(0.0, 0.0, 0.0, 1.0);

            var u_time_location = gl.getUniformLocation(program, FragmentShader.TIME_VARIABLE_NAME);
            if (!u_time_location) {
            ...
            this.diposeCalls.push(function () {
        ...
        value: function dispose() {
            window.cancelAnimationFrame(this.animateHandle);
            this.diposeCalls.reverse().forEach(function (func) {
...
FragmentShader.V_SHADER_SOURCE = 'attribute vec4 a_position;\n' + 'void main() {\n' + '  gl_Position = a_position;\n' + '}\n';
FragmentShader.TIME_VARIABLE_NAME = 'u_time';
FragmentShader.RESOLUTION_VARIABLE_NAME = 'u_resolution';
...
function getWebGLContext(canvas, options) {
    ...
    (0, _events.on)(canvas, 'webglcontextcreationerror', function (event) {
...
exports['default'] = function (context, vShader, fShader) {
    var autoUse = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;


    var gl = context,
        VERTEX_SHADER_SOURCE = vShader,
        FRAGMENT_SHADER_SOURCE = fShader;
...
// module
exports.push([module.i, ".CodeMirror{height:auto!important}", ""]);
...
var _querySelectorAll = __webpack_require__(22);
...
var _listen = __webpack_require__(20);
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!./../../css-loader/index.js??ref--1-1!./codemirror.css", function() {
			var newContent = require("!!./../../css-loader/index.js??ref--1-1!./codemirror.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!./../../css-loader/index.js??ref--1-1!./monokai.css", function() {
			var newContent = require("!!./../../css-loader/index.js??ref--1-1!./monokai.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
var _Playground = __webpack_require__(8);

var GLSLPlayground = _interopRequireWildcard(_Playground);

function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj['default'] = obj; return newObj; } }

__webpack_require__(9);

exports['default'] = GLSLPlayground['default'];
